...
<div class="container">
  ...
  <div class="footer">
    ...
    ${result.issues.length > 0 ? '<br><span style="font-size:12px;">AI vision analysis + video recording available in <a href="https://github.com/oxxo/protoscan#pro">ProtoScan Pro</a></span>' : ''}
  </div>
