...
function renderResults(issues: PluginIssue[], stats: ScanStats) {
  ...
  const issuesHtml = issues.map((issue) => `
    <div class="issue ${issue.severity}" onclick="focusNode('${issue.screenId}')">
  ...
  app.innerHTML = `
    ...
    <div class="actions">
      <button class="btn btn-primary" onclick="rescan()">Re-scan</button>
